    ...
    <header className="w-full bg-white border-b border-[#ececec]">
      <div className="hidden md:flex  justify-center  items-end max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-12">
        <nav className="flex space-x-16 items-center justify-end w-1/2 text-[#2F1D19]  ">
          <a href="/" className="text-sm font-bold text-[#2F1D19] hover:text-[#AB8E6A] uppercase">{t("nav.home")}</a>
          <a href="/product" className="text-sm text-[#2F1D19] font-bold hover:text-[#AB8E6A] uppercase">{t("nav.products")}</a>
          <a href="/about" className="text-sm text-[#2F1D19] font-bold hover:text-[#AB8E6A] uppercase">{t("nav.about")}</a>
          <a href="/contact" className="text-sm text-[#2F1D19] font-bold hover:text-[#AB8E6A] uppercase">{t("nav.contact")}</a>
        </nav>
      ...
      >
        <div className="px-4 pt-2 pb-6 flex flex-col justify-center space-y-2">
          <a href="/" onClick={() => setOpen(false)} className="block text-base font-medium tracking-wider py-2">{t("nav.home")}</a>
          <a href="/product" onClick={() => setOpen(false)} className="block text-base font-medium tracking-wider py-2">{t("nav.products")}</a>
          <a href="/about" onClick={() => setOpen(false)} className="block text-base font-medium tracking-wider py-2">{t("nav.about")}</a>
          <a href="/contact" onClick={() => setOpen(false)} className="block text-base font-medium tracking-wider py-2">{t("nav.contact")}</a>
        </div>
      </div>

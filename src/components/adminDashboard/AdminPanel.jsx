...
export default function AdminPanel() {
  ...
  if (loggedOut) {
    ...
    content = <DashboardProducts categories={categories} brands={brands} />;
  } else if (active === "products-add") {
    content = <DashboardAddProduct categories={categories} brands={brands} />;
  } else if (active === "products-restore") {
    content = <DashboardRestoreProducts categories={categories} brands={brands} />;

...
const DEFAULT_BRANDS = [
  { id: "brand-cadbury", name: "Cadbury", isActive: true },
  { id: "brand-amul", name: "Amul", isActive: true },
  { id: "brand-nestle", name: "Nestle", isActive: true },
  { id: "brand-ferrero", name: "Ferrero", isActive: true },
  { id: "brand-hersheys", name: "Hershey's", isActive: true },
  { id: "brand-lindt", name: "Lindt", isActive: true },
  { id: "brand-other", name: "Other", isActive: true },
];
...
export default function DashboardBrands({ brands: brandsProp, setBrands: setBrandsProp }) {
  ...
  const upsert = async () => {
    ...
    if (modalMode === "add") {
      ...
      setBrands((prev) => [{ id, name, isActive: true }, ...prev]);
      closeModal();
      return;
    }
